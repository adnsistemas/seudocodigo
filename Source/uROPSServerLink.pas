...
Begin
With cl.AddClassN(cl.FindClass(CS_TComponent), 'TROTRANSPORTCHANNEL') do
  begin
  end;
end;
...
Begin
With cl.AddClassN(cl.FindClass(CS_TComponent),'TROMESSAGE') do
  begin
  RegisterProperty('MESSAGENAME', Uppercase(CS_STRING), iptrw);
  RegisterProperty('INTERFACENAME', Uppercase(CS_STRING), iptrw);
  end;
end;
...
with Cl.Add(TROTRANSPORTCHANNEL) do
  begin
  RegisterVirtualConstructor(@TROTRANSPORTCHANNEL.CREATE, Uppercase(CS_CREATE));
  end;
end;
...
with Cl.Add(TROMESSAGE) do
  begin
  RegisterVirtualConstructor(@TROMESSAGE.CREATE, Uppercase(CS_CREATE));
