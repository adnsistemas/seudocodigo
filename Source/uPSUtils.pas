...
const
  ...
  PSMainProcNameOrg = 'Programa Principal';
...
const
{$ENDIF }
  RPS_InvalidFloat = 'Real no válido';
...
begin
  ...
  begin
    C := Result[I];
    if c in [#97..#122,'ñ','á','é','í','ó','ú','ü'] then
...
begin
  ...
  begin
    C := Result[I];
    if C in [#65..#90,'Ñ','Á','É','Í','Ó','Ú','Ü'] then
      Result[I] := tbtchar(Ord(Result[I]) + 32);
    Dec(I);
  end;
end;
...
const
  KEYWORD_COUNT = 82;  //*NVDS
  // tienen que estar ordenados, ya que se hace una búsqueda binaria!!
  LookupTable: array[0..KEYWORD_COUNT - 1] of TRTab = (
      (name: 'ARREGLO'; c: CSTII_array),
      (name: 'CARAC'; c: CSTII_chr),
      (name: 'CASO'; c: CSTII_caseCase),
      (name: 'CLASE'; c: CSTII_class),
      (name: 'COMO'; c: CSTII_as),
      (name: 'CON'; c: CSTII_with),
      (name: 'CONJUNTO'; c: CSTII_set),
      (name: 'CONSTANTE'; c: CSTII_const),
      (name: 'CONSTRUCTOR'; c: CSTII_constructor),
      (name: 'DE'; c: CSTII_of),
      (name: 'DECREMENTAR_HASTA'; c: CSTII_downto),
      (name: 'DESDE'; c: CSTII_forFrom),
      (name: 'DESPD'; c: CSTII_shr),
      (name: 'DESPI'; c: CSTII_shl),
      (name: 'DESTRUCTOR'; c: CSTII_destructor),
      (name: 'DIVIDIDO'; c: CSTII_div),
      (name: 'EN'; c: CSTII_in),
      (name: 'ENTONCES'; c: CSTII_then),
      (name: 'ES'; c: CSTII_is),
      (name: 'ESTRUCTURA'; c: CSTII_record),
      (name: 'EXCEPCION'; c: CSTII_except),
      (name: 'EXPORTAR'; c: CSTII_Export),
      (name: 'EXTERNO'; c: CSTII_External),
      (name: 'FIN'; c: CSTII_end),
      (Name: 'FINALIZACION'; c : CSTII_finalization),//* Nvds
      (name: 'FINALMENTE'; c: CSTII_finally),
      (name: 'FIN_ESTRUCTURA'; c: CSTII_end),
      (name: 'FIN_FUNCION'; c: CSTII_end),
      (name: 'FIN_ITERAR'; c: CSTII_end),
      (name: 'FIN_MIENTRAS'; c: CSTII_end),
      (name: 'FIN_PROCEDIMIENTO'; c: CSTII_end),
      (name: 'FIN_PROGRAMA'; c: CSTII_end),
      (name: 'FIN_SEGUN'; c: CSTII_end),
      (name: 'FIN_SI'; c: CSTII_end),
      (name: 'FIN_SUBPROGRAMAS'; c: CSTII_end),
      (name: 'FIN_VARIAR'; c: CSTII_end),
      (name: 'FUNCION'; c: CSTII_function),
      (name: 'HACER'; c: CSTII_do),
      (name: 'HASTA'; c: CSTII_to),
      (name: 'HASTA_QUE'; c: CSTII_until),
      (name: 'HEREDADO'; c: CSTII_inherited),
      (name: 'IMPLEMENTACION'; c: CSTII_Implementation),
      (Name: 'INICIALIZACION'; c: CSTII_initialization), //* Nvds
      (name: 'INICIO'; c: CSTII_begin),
      (name: 'INMUTABLE'; c: CSTII_const),
      (name: 'INTENTAR'; c: CSTII_try),
      (name: 'INTERFAZ'; c: CSTII_Interface),
      (name: 'IRA'; c: CSTII_Goto),
      (name: 'ITERAR'; c: CSTII_iterar),
      (name: 'LUEGO'; c: CSTII_Forward),
      (name: 'MIENTRAS'; c: CSTII_while),
      (name: 'MODULO'; c: CSTII_mod),
      (name: 'NO'; c: CSTII_not),
      (name: 'NULO'; c: CSTII_nil),
      (name: 'O'; c: CSTII_or),
      (name: 'OEX'; c: CSTII_xor),
      (name: 'ORDEN'; c: CSTII_ord),
      (name: 'PASO'; c: CSTII_step),
      (name: 'PORREF'; c: CSTII_var),
      (name: 'PRIVADO'; c: CSTII_private),
      (name: 'PROCEDIMIENTO'; c: CSTII_procedure),
      (name: 'PROGRAMA'; c: CSTII_program),
      (name: 'PROPIEDAD'; c: CSTII_property),
      (name: 'PROTEGIDO'; c: CSTII_protected),
      (name: 'PUBLICADO'; c: CSTII_published),
      (name: 'PUBLICO'; c: CSTII_public),
      (name: 'REPETIR'; c: CSTII_repeat),
      (name: 'ROTULO'; c: CSTII_Label),
      (name: 'SALIDA'; c: CSTII_Out),
      (name: 'SALIR'; c: CSTII_exit),
      (name: 'SALIR_SI'; c: CSTII_salirSi),
      (name: 'SEGUN'; c: CSTII_case),
      (name: 'SI'; c: CSTII_if),
      (name: 'SINO'; c: CSTII_else),
      (name: 'SOBRECARGA'; c: CSTII_override),
      //(name: 'DEFAULT'; c: CSTII_default), //Birb (if added, don't forget to increase KEYWORD_COUNT)
      (name: 'SUBPROGRAMAS'; c: CSTII_Unit),
      (name: 'TIPO'; c: CSTII_type),
      (name: 'UTILIZA'; c: CSTII_uses),
      (name: 'VARIABLES'; c: CSTII_var),
      (name: 'VARIAR'; c: CSTII_for),
...
var
  ...
  function ParseToken(var CurrTokenPos, CurrTokenLen: Cardinal; var CurrTokenId: TPSPasToken): TPSParserErrorKind;
    function TextIs(st:integer;searched:string):boolean;
    var
      n:integer;
    begin
      result := False;
    ...
    function IsIEnd(st:integer):boolean;
    begin
      result := TextIs(st,CS_iend);
    end;
    function IsAssignment(st:integer):boolean;
    begin
      result := TextIs(st,CS_assignment);
    end;
  {Parse the token}
  var
    ct, ci: Cardinal;
  ...
  begin
    ParseToken := iNoError;
    ct := CurrTokenPos;
    if IsIEnd(ct) then begin
      CurrTokenId := CSTI_IEnd;
      CurrTokenLen := Length(CS_iend);
    end else if IsAssignment(ct) then begin
      CurrTokenId := CSTI_Assignment;
      CurrTokenLen := Length(CS_assignment);
    end else begin
      case FText[ct] of
        #0:
          begin
        ...
        'A'..'Z', 'a'..'z', '_','ñ','Ñ','Á','É','Í','Ó','Ú','á','é','í','ó','ú','Ü','ü':
          begin
            ci := ct + 1;
            while (FText[ci] in ['_', '0'..'9', 'a'..'z', 'A'..'Z','ñ','Ñ','Á','É','Í','Ó','Ú','á','é','í','ó','ú','Ü','ü']) do begin
              Inc(ci);
            end;
            CurrTokenLen := ci - ct;
        ...
        CS_quote:
          begin
            ...
            begin
              ...
              if (FText[ci] = CS_quote) then
              begin
                if FText[ci+1] = CS_quote then
                  Inc(ci)
                else
                  Break;
              end;
        ...
        CS_charQuote:
          begin
            ci := ct + 2;
            if FText[ci] <> CS_charQuote then begin
        ...
        '\':
          begin
            CurrTokenId := CSTII_Div;
            CurrTokenLen := 1;
          end;
        CS_pow:
          begin
            CurrTokenId := CSTII_Pow;
            CurrTokenLen := 1;
          end;
        #32, #9, #13, #10:
          begin
            ...
            begin
              if IsIEnd(ci) then // puede ser que alguno de estos caracteres se utilice como fin de instrucción, de ser así, el WhiteSpace termina aquí
                break
              else if FText[ci] = #13 then
              begin
                inc(FRow);
                if FText[ci+1] = #10 then
                  inc(ci);
