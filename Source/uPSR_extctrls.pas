...
begin
  ...
  begin
    {$IFNDEF PS_MINIVCL}
    RegisterMethod(@TSHAPE.STYLECHANGED, CS_STYLECHANGED);
    {$ENDIF}
  end;
end;
...
begin
  ...
  begin
    RegisterPropertyHelper(@TIMAGECANVAS_R, nil, CS_CANVAS);
  end;
end;
...
begin
  ...
  begin
    RegisterPropertyHelper(@TPAINTBOXCANVAS_R, nil, CS_CANVAS);
  end;
end;
...
begin
	...
	begin
		RegisterPropertyHelper(@THEADERSECTIONWIDTH_R, @THEADERSECTIONWIDTH_W, CS_SECTIONWIDTH);
	end;
end;
{$ENDIF}
{$ENDIF}
