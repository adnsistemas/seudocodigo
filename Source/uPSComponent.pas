...
{$ENDIF }
  ...
  RPS_ScripEngineAlreadyRunning = 'El intérprete ya se encuentra funcionando';
  RPS_ScriptNotCompiled = 'El algoritmo no ha sido compilado';
  RPS_NotRunning = 'No se está ejecutando';
...
begin
  ...
  case t of
    ...
    btS8,btU16,btS16,btU32,btS32: begin
      Integer(Data) := 0;
      case t of
        btS8:limit := High(shortint); //entero_mínimo
        btU16:limit := High(word); //ordinal_pequeño
        btS16:limit := High(smallint);//entero_pequeño
