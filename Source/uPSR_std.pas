...
begin
  ...
  begin
    RegisterConstructor(@TObject.Create, Uppercase(CS_CREATE));
    RegisterMethod(@TObject.Free, Uppercase(CS_FREE));
  end;
end;
...
begin
  ...
  begin
    RegisterVirtualMethod(@TPersistent.Assign, Uppercase(CS_ASSIGN));
  end;
end;
...
begin
  ...
  begin
    RegisterMethod(@TComponent.FindComponent, Uppercase(CS_FINDCOMPONENT));
    RegisterVirtualConstructor(@TComponent.Create, Uppercase(CS_CREATE));
    RegisterPropertyHelper(@TComponentOwnerR, nil, Uppercase(CS_OWNER));

    RegisterMethod(@TCOMPONENT.DESTROYCOMPONENTS, Uppercase(CS_DESTROYCOMPONENTS));
    RegisterPropertyHelper(@TCOMPONENTCOMPONENTS_R, nil, Uppercase(CS_COMPONENTS));
    RegisterPropertyHelper(@TCOMPONENTCOMPONENTCOUNT_R, nil, Uppercase(CS_COMPONENTCOUNT));
    RegisterPropertyHelper(@TCOMPONENTCOMPONENTINDEX_R, @TCOMPONENTCOMPONENTINDEX_W, Uppercase(CS_COMPONENTINDEX));
    RegisterPropertyHelper(@TCOMPONENTCOMPONENTSTATE_R, nil, Uppercase(CS_COMPONENTSTATE));
    RegisterPropertyHelper(@TCOMPONENTDESIGNINFO_R, @TCOMPONENTDESIGNINFO_W, Uppercase(CS_DESIGNINFO));
  end;
end;
