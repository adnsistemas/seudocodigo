...
{$ENDIF }
  ...
  RPS_TooManyNestedInclude = 'Demasiadas inclusiones procesando ''%s'' incluido en ''%s''';
  RPS_IncludeNotFound = 'No se puede localizar el archivo ''%s'' utilizado en ''%s''';
  RPS_DefineTooManyParameters = 'Demasiados parámetros en %d:%d';
  RPS_NoIfdefForEndif = 'FinSi sin SiDef en %d:%d';
  RPS_NoIfdefForElse = 'Else sin SiDef en %d:%d';
  RPS_ElseTwice = 'No se puede utilizar Sino dos veces en %d:%d';
  RPS_UnknownCompilerDirective = 'Directiva desconocida en %d:%d';
  RPs_DefineNotClosed = 'Definición no cerrada';
